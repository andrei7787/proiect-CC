...
export function CourseCreate({ token: _token, onCreate, onCancel }: CourseCreateProps) {
  ...
  return (
    <div className="course-create-wrapper">
      <form className="panel course-create-panel" onSubmit={handleSubmit}>
        <h2>New course</h2>
        <p className="login-hint">Set up a course to start generating AI study plans.</p>
