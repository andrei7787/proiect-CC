...
import { confirmRegistration, loginWithCognito, registerWithCognito } from "./cognito";
...
describe("auth", () => {
  ...
  describe("confirmRegistration", () => {
    it("confirms the user with the code", async () => {
      ...
      await expect(confirmRegistration("new@test.com", "123456")).resolves.toBeUndefined();
    });
  });
